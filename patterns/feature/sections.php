 ...
 */
?>
<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|md","bottom":"var:preset|spacing|md","right":"var:preset|spacing|xs","left":"var:preset|spacing|xs"}},"position":{"all":"relative"}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignwide"
     style="padding-top:var(--wp--preset--spacing--md);padding-right:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--md);padding-left:var(--wp--preset--spacing--xs)">
    <!-- wp:spacer {"height":"600px","style":{"width":{"all":"600px"},"position":{"all":"absolute"},"right":{"all":""},"top":{"all":"0px"},"bottom":{"all":"0px"},"left":{"all":"-300px"},"zIndex":{"all":"-1"}},"gradient":"circle"} -->
    <div style="height:600px" aria-hidden="true"
         class="wp-block-spacer has-circle-gradient-background has-background"></div>
    <!-- /wp:spacer -->
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-center">
        <!-- wp:column {"verticalAlignment":"center","style":{"position":"","zIndex":"","top":"","right":"","bottom":"","left":""},"animation":{"name":"fade-in-up","duration":1,"delay":"0"}} -->
        <div class="wp-block-column is-vertically-aligned-center has-animation"
             style="animation-name:fade-in-up;animation-duration:1s;animation-delay:0s;animation-iteration-count:1">
            <!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group">
                <!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"is-style-sub-heading"} -->
            ...
            <h3 class="wp-block-heading has-heading-gradient-background has-background has-36-font-size">
                Solutions to help your business grow</h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            <p>Our platform provides you with real-time data and insights to
                help you improve customer experience and maximize
                conversion.</p>
            <!-- /wp:paragraph -->
            <!-- wp:columns -->
            <div class="wp-block-columns"><!-- wp:column -->
                <div class="wp-block-column">
                    <!-- wp:list {"className":"is-style-checklist-circle"} -->
        ...
        <div class="wp-block-column is-vertically-aligned-center has-transform is-style-light has-primary-gradient-background has-background has-animation"
             style="padding-top:var(--wp--preset--spacing--md);padding-right:var(--wp--preset--spacing--md);padding-bottom:0;padding-left:var(--wp--preset--spacing--md);animation-name:fade-in-up;animation-duration:1s;animation-delay:1s;animation-iteration-count:1">
            <!-- wp:group {"style":{"position":{"all":"relative"},"zIndex":{"all":"1"},"spacing":{"blockGap":"var:preset|spacing|sm"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"right"}} -->
            <div class="wp-block-group">
                ...
                <div class="wp-block-group is-style-surface has-background has-animation"
                     style="border-radius:8px;background-color:#fffffffc;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--sm);padding-right:var(--wp--preset--spacing--sm);padding-bottom:var(--wp--preset--spacing--sm);padding-left:var(--wp--preset--spacing--sm);animation-name:fade-in-up;animation-duration:1s;animation-delay:1s;animation-iteration-count:1">
                    <!-- wp:image {"style":{"spacing":{"padding":{"top":"var:preset|spacing|xxs","right":"var:preset|spacing|xxs","bottom":"var:preset|spacing|xxs","left":"var:preset|spacing|xxs"}},"border":{"radius":"99px"}},"className":"is-style-icon","textColor":"accent-500","gradient":"primary-lighter","iconSet":"heroicons","iconName":"chart-bar-square","iconSize":"","iconSvgString":"\u003csvg xmlns=\u0022http://www.w3.org/2000/svg\u0022 fill=\u0022none\u0022 stroke=\u0022currentColor\u0022 stroke-width=\u00221.5\u0022 aria-hidden=\u0022true\u0022 viewBox=\u00220 0 24 24\u0022\u003e\u003cpath stroke-linecap=\u0022round\u0022 stroke-linejoin=\u0022round\u0022 d=\u0022M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25z\u0022/\u003e\u003c/svg\u003e"} -->
                    <figure class="wp-block-image has-custom-border is-style-icon has-accent-500-color has-primary-lighter-gradient-background has-text-color has-background"
                            style="border-radius:99px;padding-top:var(--wp--preset--spacing--xxs);padding-right:var(--wp--preset--spacing--xxs);padding-bottom:var(--wp--preset--spacing--xxs);padding-left:var(--wp--preset--spacing--xxs);--wp--custom--icon--color:var(--wp--preset--color--accent-500,currentColor);--wp--custom--icon--background:var(--wp--preset--gradient--primary-lighter,currentColor);--wp--custom--icon--padding:var(--wp--preset--spacing--xxs) var(--wp--preset--spacing--xxs) var(--wp--preset--spacing--xxs) var(--wp--preset--spacing--xxs);--wp--custom--icon--url:url('data:image/svg+xml;utf8,<svg xmlns=&quot;http://www.w3.org/2000/svg&quot; fill=&quot;none&quot; stroke=&quot;currentColor&quot; stroke-width=&quot;1.5&quot; aria-hidden=&quot;true&quot; viewBox=&quot;0 0 24 24&quot;&gt;<path stroke-linecap=&quot;round&quot; stroke-linejoin=&quot;round&quot; d=&quot;M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0 0 20.25 18V6A2.25 2.25 0 0 0 18 3.75H6A2.25 2.25 0 0 0 3.75 6v12A2.25 2.25 0 0 0 6 20.25z&quot;/&gt;</svg&gt;')">
                        <img src="#" alt="" style="border-radius:99px"/>
                    </figure>
                    <!-- /wp:image -->
                    <!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
                    <div class="wp-block-group">
                        <!-- wp:paragraph {"style":{"color":{"text":"#1a1533"}},"className":"is-style-heading"} -->
                        <p class="is-style-heading has-text-color"
                           style="color:#1a1533">Real time analytics</p>
                        <!-- /wp:paragraph -->
                        <!-- wp:paragraph {"fontSize":"16"} -->
                        <p class="has-16-font-size">Track your sales in real
                            time</p>
                        <!-- /wp:paragraph --></div>
                    <!-- /wp:group --></div>
                <!-- /wp:group -->
                ...
                <div class="wp-block-group">
                    <!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|xs"},"width":{"all":"90%"},"color":{"background":"#ffffffed"},"border":{"radius":"8px"}},"className":"is-style-surface","layout":{"type":"flex","flexWrap":"nowrap"},"animation":{"name":"fade-in-up","duration":1,"delay":"1.5"}} -->
                    <div class="wp-block-group is-style-surface has-background has-animation"
                         style="border-radius:8px;background-color:#ffffffed;margin-top:0;margin-bottom:0;animation-name:fade-in-up;animation-duration:1s;animation-delay:1.5s;animation-iteration-count:1">
                        ...
                        <div class="wp-block-group">
                            <!-- wp:paragraph {"style":{"color":{"text":"#1a1533"}},"className":"is-style-heading"} -->
                            <p class="is-style-heading has-text-color"
                               style="color:#1a1533">Rock solid foundation</p>
                            <!-- /wp:paragraph -->
                            <!-- wp:paragraph {"fontSize":"16"} -->
                            <p class="has-16-font-size">Build your business with
                                the best</p>
                            <!-- /wp:paragraph --></div>
                        <!-- /wp:group --></div>
                    <!-- /wp:group --></div>
                ...
                <div class="wp-block-group is-style-surface has-background has-animation"
                    ...
                    <!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
                    <div class="wp-block-group">
                        <!-- wp:paragraph {"style":{"color":{"text":"#272144"}},"className":"is-style-heading"} -->
                        <p class="is-style-heading has-text-color"
                           style="color:#272144">Conversion focussed</p>
                        <!-- /wp:paragraph -->
                        <!-- wp:paragraph {"fontSize":"16"} -->
                        <p class="has-16-font-size">Convert more visitors into
                            customers</p>
                        <!-- /wp:paragraph --></div>
                    <!-- /wp:group --></div>
                <!-- /wp:group --></div>
    ...
    <!-- /wp:columns --></div>
<!-- /wp:group -->
<!-- wp:group {"align":"wide","style":{"u002du002dposition":"relative","u002du002dz-index":"1","position":{"all":"relative"},"zIndex":{"all":"1"},"spacing":{"padding":{"top":"var:preset|spacing|md","bottom":"var:preset|spacing|md","right":"var:preset|spacing|xs","left":"var:preset|spacing|xs"},"margin":{"top":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignwide"
     style="margin-top:0;padding-top:var(--wp--preset--spacing--md);padding-right:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--md);padding-left:var(--wp--preset--spacing--xs)">
    <!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|xxl","left":"var:preset|spacing|xxl"}}}} -->
    <div class="wp-block-columns alignwide are-vertically-aligned-center">
        ...
        <div class="wp-block-column is-vertically-aligned-center has-transform is-style-light has-primary-gradient-background has-background has-animation"
             style="padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:0;padding-left:var(--wp--preset--spacing--lg);animation-name:fade-in-up;animation-duration:1s;animation-iteration-count:1">
            <!-- wp:image {"id":160,"sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":{"topLeft":"15px","topRight":"15px","bottomLeft":"0px","bottomRight":"0px"}},"boxShadow":""}} -->
            <figure class="wp-block-image size-large has-custom-border"
                    style="border-top-left-radius:15px;border-top-right-radius:15px;border-bottom-left-radius:0px;border-bottom-right-radius:0px">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/screenshot-1024x768.png"
                     alt="" class="wp-image-160"
                     style="border-top-left-radius:15px;border-top-right-radius:15px;border-bottom-left-radius:0px;border-bottom-right-radius:0px"/>
            </figure>
            <!-- /wp:image -->
            ...
            <div class="wp-block-group is-style-surface has-background has-animation"
                 style="border-style:none;border-width:0px;border-radius:8px;background-color:#fffffe;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xs);padding-right:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--xs);padding-left:var(--wp--preset--spacing--xs);animation-name:fade-in-up;animation-duration:1s;animation-delay:.5s;animation-iteration-count:1">
                ...
                <figure class="wp-block-image has-custom-border is-style-icon has-accent-500-color has-primary-lighter-gradient-background has-text-color has-background"
                        style="border-radius:99px;padding-top:var(--wp--preset--spacing--xxs);padding-right:var(--wp--preset--spacing--xxs);padding-bottom:var(--wp--preset--spacing--xxs);padding-left:var(--wp--preset--spacing--xxs);--wp--custom--icon--color:var(--wp--preset--color--accent-500,currentColor);--wp--custom--icon--background:var(--wp--preset--gradient--primary-lighter,currentColor);--wp--custom--icon--padding:var(--wp--preset--spacing--xxs) var(--wp--preset--spacing--xxs) var(--wp--preset--spacing--xxs) var(--wp--preset--spacing--xxs);--wp--custom--icon--url:url('data:image/svg+xml;utf8,<svg xmlns=&quot;http://www.w3.org/2000/svg&quot; fill=&quot;none&quot; stroke=&quot;currentColor&quot; stroke-width=&quot;1.5&quot; aria-hidden=&quot;true&quot; viewBox=&quot;0 0 24 24&quot;&gt;<path stroke-linecap=&quot;round&quot; stroke-linejoin=&quot;round&quot; d=&quot;M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75zm6.75-4.5c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625zm6.75-4.5c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125z&quot;/&gt;</svg&gt;')">
                    <img src="#" alt="" style="border-radius:99px"/></figure>
                <!-- /wp:image -->
                <!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
                <div class="wp-block-group">
                    <!-- wp:paragraph {"textColor":"neutral-800","className":"is-style-heading"} -->
                    <p class="is-style-heading has-neutral-800-color has-text-color">
                        Boost sales</p>
                    <!-- /wp:paragraph -->
            ...
            <div class="wp-block-group is-style-surface has-background has-animation"
                 style="border-style:none;border-width:0px;border-radius:8px;background-color:#fefefe82;padding-top:var(--wp--preset--spacing--xs);padding-right:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--xs);padding-left:var(--wp--preset--spacing--xs);animation-name:fade-in-up;animation-duration:1s;animation-delay:1s;animation-iteration-count:1">
                <!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
                <div class="wp-block-group">
                    <!-- wp:paragraph {"textColor":"neutral-800","className":"is-style-heading"} -->
                    <p class="is-style-heading has-neutral-800-color has-text-color">
        ...
        <div class="wp-block-column is-vertically-aligned-center has-animation"
             style="padding-right:var(--wp--preset--spacing--md);animation-name:fade-in-up;animation-duration:1s;animation-delay:1s;animation-iteration-count:1">
            <!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group">
                <!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"is-style-sub-heading"} -->
                <p class="alignleft has-text-align-left is-style-sub-heading alignleft"
            ...
            <!-- wp:heading {"level":3,"gradient":"heading","className":"wp-block-heading","fontSize":"36"} -->
            <h3 class="wp-block-heading has-heading-gradient-background has-background has-36-font-size">
                Personalized content powered by AI</h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            <p>Advanced AI-powered algorithms that help you optimize your
                marketing campaigns and drive revenue growth</p>
            <!-- /wp:paragraph -->
            <!-- wp:columns -->
            <div class="wp-block-columns"><!-- wp:column -->
                <div class="wp-block-column">
    ...
    <!-- /wp:columns --></div>
<!-- /wp:group -->
<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|md","bottom":"var:preset|spacing|md","right":"var:preset|spacing|xs","left":"var:preset|spacing|xs"},"margin":{"top":"0"}},"position":{"all":"relative"}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignwide"
     style="margin-top:0;padding-top:var(--wp--preset--spacing--md);padding-right:var(--wp--preset--spacing--xs);padding-bottom:var(--wp--preset--spacing--md);padding-left:var(--wp--preset--spacing--xs)">
    <!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|lg","left":"var:preset|spacing|xxl"}}}} -->
    <div class="wp-block-columns alignwide are-vertically-aligned-center">
        <!-- wp:column {"verticalAlignment":"center","style":{"order":{"mobile":2},"display":"","width":"","maxWidth":""},"animation":{"name":"fade-in-up","duration":1}} -->
        <div class="wp-block-column is-vertically-aligned-center has-animation"
             style="animation-name:fade-in-up;animation-duration:1s;animation-iteration-count:1">
            <!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
            <div class="wp-block-group">
                <!-- wp:paragraph {"align":"left","style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}}},"className":"is-style-sub-heading"} -->
                <p class="alignleft has-text-align-left is-style-sub-heading alignleft"
            ...
            <!-- wp:heading {"level":3,"gradient":"heading","className":"wp-block-heading","fontSize":"36"} -->
            <h3 class="wp-block-heading has-heading-gradient-background has-background has-36-font-size">
                Real time insights and automated reporting</h3>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            <p>Our platform uses machine learning to provide you with real-time
                data and insights to help you optimize your strategies and
                increase your ROI.</p>
            <!-- /wp:paragraph -->
            <!-- wp:columns -->
            <div class="wp-block-columns"><!-- wp:column -->
        ...
        <div class="wp-block-column is-vertically-aligned-center has-transform is-style-light has-primary-gradient-background has-background has-animation"
             style="border-style:none;border-width:0px;padding-top:var(--wp--preset--spacing--md);padding-right:var(--wp--preset--spacing--md);padding-bottom:0;padding-left:var(--wp--preset--spacing--md);animation-name:fade-in-up;animation-duration:1s;animation-delay:1s;animation-iteration-count:1">
            <!-- wp:columns {"isStackedOnMobile":false,"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":{"top":"var:preset|spacing|sm","left":"var:preset|spacing|sm"}},"position":{"all":"relative"},"zIndex":{"all":"1"}},"animation":{}} -->
            <div class="wp-block-columns is-not-stacked-on-mobile"
                 style="margin-top:0;margin-bottom:0">
                <!-- wp:column {"verticalAlignment":"top","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|md"}}},"className":"is-style-default","layout":{"type":"default"}} -->
                <div class="wp-block-column is-vertically-aligned-top is-style-default"
                     style="padding-bottom:var(--wp--preset--spacing--md)">
                    <!-- wp:group {"style":{"typography":{"lineHeight":1},"spacing":{"blockGap":"var:preset|spacing|xxs"},"color":{"background":"#fffffffc"}},"className":"is-style-surface","layout":{"type":"flex","orientation":"vertical","justifyContent":"left"},"animation":{"name":"fade-in-up","duration":1,"delay":"0"}} -->
                    <div class="wp-block-group is-style-surface has-background has-animation"
                         style="background-color:#fffffffc;line-height:1;animation-name:fade-in-up;animation-duration:1s;animation-delay:0s;animation-iteration-count:1">
                        ...
                        <p class="is-style-counter is-style-heading has-text-color has-24-font-size"
                           style="color:#1a1533;padding-top:var(--wp--preset--spacing--xxs)">
                            10%</p>
                        <!-- /wp:paragraph -->
                    ...
                    <div class="wp-block-group is-style-surface has-background has-animation"
                         style="background-color:#ffffffde;margin-top:var(--wp--preset--spacing--sm);line-height:1;animation-name:fade-in-up;animation-duration:1s;animation-delay:0.2s;animation-iteration-count:1">
                ...
                <div class="wp-block-column is-vertically-aligned-bottom is-style-default"
                     style="padding-top:var(--wp--preset--spacing--md)">
                    <!-- wp:group {"style":{"typography":{"lineHeight":1},"spacing":{"blockGap":"var:preset|spacing|xxs"},"color":{"background":"#ffffffed"}},"className":"is-style-surface","layout":{"type":"flex","orientation":"vertical","justifyContent":"left"},"animation":{"name":"fade-in-up","duration":1,"delay":"0"}} -->
                    <div class="wp-block-group is-style-surface has-background has-animation"
                         style="background-color:#ffffffed;line-height:1;animation-name:fade-in-up;animation-duration:1s;animation-delay:0s;animation-iteration-count:1">
    ...
    <div style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;height:600px"
         aria-hidden="true"
         class="wp-block-spacer has-circle-gradient-background has-background"></div>
    <!-- /wp:spacer --></div>
<!-- /wp:group -->